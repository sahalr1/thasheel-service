...
public class Branch implements Serializable {
    ...
    public Branch streetAddress(String streetAddress) {
    ...
    public Branch stateProvince(String stateProvince) {
    ...
    public Branch manager(BranchManager branchManager) {
        this.manager = branchManager;
        return this;
    }

    public void setManager(BranchManager branchManager) {
        this.manager = branchManager;
    }
    ...
    public Branch country(Country country) {
